...
import { ActualiteCategorieDetailComponent } from '../actualite-categorie-detail/actualite-categorie-detail.component';
import { ActualiteCategorieEditComponent } from '../actualite-categorie-edit/actualite-categorie-edit.component';
import { MatDialog } from '@angular/material/dialog';
import { ActualiteCategorieAjouterComponent } from '../actualite-categorie-ajouter/actualite-categorie-ajouter.component';
import { ActualiteArticleDetailComponent } from '../actualite-article-detail/actualite-article-detail.component';
import { ActualiteArticleEditComponent } from '../actualite-article-edit/actualite-article-edit.component';
import { ActualiteArticleAjouterComponent } from '../actualite-article-ajouter/actualite-article-ajouter.component';
...
export class UserComponent implements OnInit, OnDestroy {
  ...
  private titleSubject = new BehaviorSubject<string>('profil');
  ...
  popupCategorieDetail(categorie: ICategorie) {
    this.matDialog.open(
      ActualiteCategorieDetailComponent,
      {
        width: '80%',
